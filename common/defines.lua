...
NAI = {
	...
	AGGRESSIVENESS_BONUS_EASY_WAR = 800, -- Added to aggressiveness if the war is against a weak or particularily hated enemy
	MISSION_PICK_CHANCE = 50, -- Yearly chance of AI picking a mission if it lacks one
